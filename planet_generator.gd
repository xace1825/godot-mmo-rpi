...
static func is_indoor_building(building_type: int) -> bool:
	match building_type:
		BuildingType.FLOOR, BuildingType.WALL, BuildingType.DOOR, BuildingType.BED, BuildingType.SAWMILL, BuildingType.KITCHEN, BuildingType.MINE, BuildingType.CARPENTER, BuildingType.MASON, BuildingType.SMITHY, BuildingType.TABLE:
			return true
		_:
			return false
...
static func get_building_category(building_type: int) -> int:
	match building_type:
		...
		BuildingType.SAWMILL, BuildingType.FARM, BuildingType.MINE, BuildingType.KITCHEN, BuildingType.CARPENTER, BuildingType.MASON, BuildingType.SMITHY:
...
static func get_job_slots(building_type: int) -> int:
	match building_type:
		BuildingType.SAWMILL, BuildingType.FARM, BuildingType.MINE, BuildingType.CARPENTER, BuildingType.MASON:
			return 2
		BuildingType.KITCHEN, BuildingType.SMITHY:
			return 1
		_:
			return 0
